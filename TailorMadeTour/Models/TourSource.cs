...
namespace TailorMadeTour.Models {
	class TourSource {
		...
		static TourSource() {
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUri = "/TailorMadeTour;component/Images/Stops/Pastry.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUri = "/TailorMadeTour;component/Images/Stops/Fountain.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUri = "/TailorMadeTour;component/Images/Stops/ArtInstitute.jpg",
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUri = "/TailorMadeTour;component/Images/Stops/Lunch.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUri = "/TailorMadeTour;component/Images/Stops/Cloud.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUri = "/TailorMadeTour;component/Images/Stops/Garden.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUri = "/TailorMadeTour;component/Images/Stops/Pretzel.jpg"
			});
		}
